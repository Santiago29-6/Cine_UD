...
if (isset($_SESSION['usuario'])) {
    ...
    if (isset($_POST['grabar']) && $_POST['grabar'] == 'si') {
        $usu->editusuario($_POST['id'], $_POST['n'], $_POST['a'], $_POST['c'], $_POST['contra']);
        exit();
    }
    //llamar la funcion ver empleados
    $reg = $usu->get_usuario($_GET['id']);
?>
    <!doctype html>
    <html lang="es">
...
-->
    ...
    <body onload="limpiar();">
        <div class="container">
            <div class="card-body">
                <form name="form" action="editar_usuario.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="id">CÉDULA</label>
                            <input type='hidden' name='grabar' value='si'>
                            <input type="number" name="id" class="form-control" value="<?php echo $reg[0]['cedula']; ?>" readonly placeholder="DIGITE EL CODIGO">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="c" class="form-control" value="<?php echo $reg[0]['correo']; ?>" placeholder="DIGITE LA CONTRASEÑA">
                        </div>
                        <div class="col-md-6">
